  ...
  const [drones, setDrones] = useState<Drone[]>([
    {
      ...
      name: 'Drone Alpha',
      type: 'drone',
      point: { lat: 40.758526, lon: -73.901238, hae: 0 },
      route: [
        { lat: 40.758526, lon: -73.901238, hae: 150 },
        { lat: 40.759526, lon: -73.981238, hae: 100 },
        { lat: 40.760526, lon: -73.901238, hae: 0 },
      ],
      speed: 10,
      isPaused: true,
      sensorInfo: {
    ...
    },
    {
      ...
      name: 'Drone Beta',
      type: 'drone',
      point: { lat: 40.759526, lon: -73.901238, hae: 100 },
      route: [],
      speed: 20,
      isPaused: false,
      sensorInfo: {
    ...
    },
    {
      ...
      name: 'Drone Gamma',
      type: 'drone',
      point: { lat: 40.760526, lon: -73.901238, hae: 0 },
      route: [],
      speed: 20,
      isPaused: false,
      sensorInfo: {
      ...
      modelUri: '/models/base_basic_pbr.glb',
    },
  ]);
